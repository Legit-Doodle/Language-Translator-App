...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Hindi","Arabic","Bulgarian","Bengali","Catalan","Czech","Welsh","German","Urdu"};

    String[] toLanguages = {"To","English","Hindi","Arabic","Bulgarian","Bengali","Catalan","Czech","Welsh","German","Hindi","Urdu"};
    ...
    private void translateText(int fromLanguageCode,int toLanguageCode,String source){
        ...
        translator.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity.this,"Fail to download Langugate Model",Toast.LENGTH_SHORT).show();
            }
        });
    }
